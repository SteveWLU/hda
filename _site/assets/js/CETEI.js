      ...
      let convertEl = el => {
        ...
        for (let att of Array.from(el.attributes)) {
          if (!att.name.startsWith("xmlns") || copy) {
            ...
            if (att.name == "xmlns") newElement.setAttribute("data-xmlns", att.value); //Strip default namespaces, but hang on to the values
          }
        ...
        if (el.localName == "prefixDef") {
          ...
          this.prefixes[el.getAttribute("ident")] = { "matchPattern": el.getAttribute("matchPattern"),
